        ...
        *,
        ...
        try:
            ...
            plan = build_repair_apply_plan(
                ...
                selector_preset=str(selector_preset),
                selector_presets_file=Path(selector_presets_file) if selector_presets_file else self.root / "config/agent_repair_selector_presets.json",
        ...
        if apply and not bool(approval_state.get("approved", False)):
            ...
            return error_response(
                ...
                meta={
                    ...
                    "max_actions": max(0, int(max_actions)),
                    "selector_preset": str(selector_preset),
                    "selector_presets_file": str(selector_presets_file),
                    "scopes": _csv_values(scopes),
                    "strategies": _csv_values(strategies),
                    "task_kinds": _csv_values(task_kinds),
                    "exclude_scopes": _csv_values(exclude_scopes),
