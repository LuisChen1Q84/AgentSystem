...
.PHONY: help morning done iterate archive health index search lifecycle \
	...
	skill-route skill-execute autonomous image-hub image-hub-observe
...
help:
	...
	@echo "  make skill-route text='...' | skill-execute text='...' [params='{\"k\":\"v\"}'] | autonomous text='...' [params='{\"k\":\"v\"}'] | image-hub text='...' [params='{\"k\":\"v\"}'] | image-hub-observe [days=7]"
