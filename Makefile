...
.PHONY: help morning done iterate archive health index search lifecycle \
	...
	skill-route skill-execute autonomous agent agent-studio agent-observe agent-recommend agent-failure-review agent-repair-apply agent-repair-list agent-repair-compare agent-repair-rollback agent-run-inspect agent-policy agent-pack agent-slo-guard agent-golden agent-fault agent-feedback agent-learn capability-catalog skill-contract-lint autonomy-observe autonomy-eval image-hub image-hub-observe
...
help:
	...
	@echo "  make skill-route text='...' | skill-execute text='...' [params='{\"k\":\"v\"}'] | autonomous text='...' [params='{\"k\":\"v\"}'] | agent text='...' [params='{\"profile\":\"strict|adaptive|auto\"}'] | agent-studio [cmd='repl|run|observe|recommend|diagnostics|failure-review|repair-apply|repair-list|repair-compare|repair-rollback|run-inspect|slo|policy|pending|feedback-add|feedback-stats|services|call'] [service='mcp.run|ppt.generate|image.generate|market.report|data.query|agent.diagnostics|agent.failures.review|agent.repairs.apply|agent.repairs.list|agent.repairs.compare|agent.repairs.rollback|agent.run.inspect|agent.policy.tune'] [params='{\"k\":\"v\"}'] | agent-observe [days=14] | agent-recommend [days=30] [apply=1] | agent-failure-review [days=14] [limit=10] | agent-repair-apply [days=14] [limit=10] [apply=1] [approve_code='...'] | agent-repair-list [limit=20] | agent-repair-compare [snapshot_id='...'] [base_snapshot_id='...'] | agent-repair-rollback [snapshot_id='...'] [only='both|profile|strategy'] | agent-run-inspect run_id='...' | agent-policy [days=14] | agent-pack cmd='list|enable|disable' [name='finance'] | agent-slo-guard [enforce=1] | agent-golden [strict=1] | agent-fault [strict=1] | agent-feedback cmd='add|stats|pending' [run_id='...'] [rating='1|-1'] | agent-learn [apply=1] | capability-catalog | skill-contract-lint [strict=1] | autonomy-observe [days=14] | autonomy-eval | image-hub text='...' [params='{\"k\":\"v\"}'] | image-hub-observe [days=7]"
